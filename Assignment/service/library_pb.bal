...
public client class LibrarianNilCaller {
...
public client class LibrarianRespondsCaller {
    private grpc:Caller caller;
...
public client class LibrarianBookCaller {
    private grpc:Caller caller;
...
public client class StudentBookCaller {
    private grpc:Caller caller;
